            ...
            {status !== 'success' && (
              <div className="space-y-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  {serverError && (
                    <div className="p-4 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-300 text-xs font-mono space-y-1">
                      <p className="font-bold">Message Delivery Notice:</p>
                      <p>{serverError}</p>
                    </div>
                  )}
